...
int Total_Events,Total_Events_To_Be_Processed;
G4double VoxalizedPhantomSizeX,VoxalizedPhantomSizeY,VoxalizedPhantomSizeZ;
...
std::ofstream  dosimetricFile,TextFile;
