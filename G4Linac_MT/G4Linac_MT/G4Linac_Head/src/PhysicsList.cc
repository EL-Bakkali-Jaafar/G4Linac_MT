...
HadronInelasticPhysicsList = new G4HadronInelasticQBBC();
...
HadronElasticPhysicsList->ConstructParticle();
HadronInelasticPhysicsList->ConstructParticle();
IonBinaryCascadePhysicsList->ConstructParticle();
...
HadronInelasticPhysicsList->ConstructProcess();
