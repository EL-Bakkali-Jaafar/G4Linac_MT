...
G4UIcmdWithAnInteger* GENERATOR_FLAG_Cmd;
G4UIcmdWithADoubleAndUnit *GantryRotAngleCmd;
G4UIcmdWithABool* CollimatorRotAngleFlagCmd;
G4UIcmdWithADoubleAndUnit *CollimatorRotAngleCmd;
G4UIcmdWithAString  *NameOfGeomFromTextFileCmd;
G4UIcmdWithABool*GantryRotAngleFlagCmd;
G4UIcmdWithADoubleAndUnit *StepMaxCmd;
G4UIcmdWithABool* StepMaxFlagCmd;
};
