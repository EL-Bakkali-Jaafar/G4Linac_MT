...
void SET_PARAMETERS(G4String, bool, G4double, int, int);
void CollimatorRotatingDone(G4double);
void GantryRotatingDone(G4double);
...
G4double particle_time,pos_x, pos_y, pos_z, dir_x,dir_y,dir_z, Z_STOP, energy,Z_plane;
G4String FileName;
