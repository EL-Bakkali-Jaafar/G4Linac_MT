...
void SetParametersForPhaseSpaceDataSpatialDistXY_With_Kinetic(G4String,int,G4double,G4double,int,G4double,G4double);
...
void Save();
void Fill_Dose_2DHeatMap( G4double , G4double ,G4double );
