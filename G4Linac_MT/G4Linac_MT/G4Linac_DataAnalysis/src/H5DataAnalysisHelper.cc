...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::Get_DOSE(int xid,int yid, int zid){
G4double dose;
int incr=-1;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxDosePdd(int xid, int yid)
{
G4double dose;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxDoseHeatMap(int zid, std::string axis){
 G4double dose;
G4double max_dose=0.0;
    ...
    for ( unsigned i =0; i< data_size_DosimetricData; i++)
{
          ...
          if ( this->RAM_DosimetricData[i].VOXEL_YID==zid )  
{
            dose=this->RAM_DosimetricData[i].DOSE;
if (  max_dose <=dose) { max_dose=dose;}
}
    ...
    for ( unsigned i =0; i< data_size_DosimetricData; i++)
{
          ...
          if ( this->RAM_DosimetricData[i].VOXEL_XID==zid )  
{
            dose=this->RAM_DosimetricData[i].DOSE;
if (  max_dose <=dose) { max_dose=dose;}
}
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinDoseYProfile(int xcid, int zcid){
 G4double dose;
G4double min_dose=0.0;
 int incr=-1;
    ...
    for ( unsigned i =0; i< data_size_DosimetricData; i++)
{
     if ( this->RAM_DosimetricData[i].VOXEL_ZID==zcid and this->RAM_DosimetricData[i].VOXEL_XID==xcid  )
{  
incr++;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinDoseXProfile(int ycid, int zcid){
 G4double dose;
G4double min_dose=0.0;
 int incr=-1;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinRSDXProfile(int ycid, int zcid){
 G4double rsd;
G4double min_rsd=0.0;
 int incr=-1;
...
{  
incr++;
if (incr==0){min_rsd= this->RAM_DosimetricData[i].RSD;};
        //
            rsd=this->RAM_DosimetricData[i].RSD;
if (  min_rsd >=rsd) { min_rsd=rsd;}
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxRSDXProfile(int xcid, int zcid){
 G4double rsd;
G4double max_rsd=0.0;
    ...
    for ( unsigned i =0; i< data_size_DosimetricData; i++)
{
          ...
          if ( this->RAM_DosimetricData[i].VOXEL_XID==xcid and  this->RAM_DosimetricData[i].VOXEL_ZID==zcid )  
{

            rsd=this->RAM_DosimetricData[i].RSD;
if (  max_rsd <=rsd) { max_rsd=rsd;}
}
      }
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinRSDYProfile(int xcid, int zcid){
 G4double rsd;
G4double min_rsd=0.0;
 int incr=-1;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxRSDYProfile(int ycid, int zcid){
 G4double rsd;
G4double max_rsd=0.0;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxDoseYProfile(int xcid, int zcid){
 G4double dose;
G4double max_dose=0.0;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxDoseXProfile(int ycid, int zcid){
 G4double dose;
G4double max_dose=0.0;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinRSDPdd(int xid, int yid)
{//1
 G4double rsd;
G4double min_rsd=0.0;
 int incr=-1;
...
incr++;
       if (incr==0)
{//4
min_rsd= this->RAM_DosimetricData[i].RSD;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMaxRSDPdd(int xid, int yid){
 G4double rsd;
G4double max_rsd=0.0;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinDosePdd(int xid, int yid){
 G4double dose;
G4double min_dose=0.0;
 int incr=-1;
...
/*#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=#=*/
G4double H5DataAnalysisHelper::GetMinDoseHeatMap(int  zid,std::string axis){
G4double min_dose=0.0;
if (axis=="z"){
 G4double dose;
