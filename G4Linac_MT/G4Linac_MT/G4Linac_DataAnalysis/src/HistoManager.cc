...
void HistoManager::SetParametersForPhaseSpaceDataSpatialDistXY_With_Kinetic(G4String _title, int Nxbin,G4double max_x, G4double min_x,int Nybin, G4double max_y, G4double min_y){
...
analysisManager->CreateP2("particle_spatial_distribution_xy_with_kinetic", _title,
                          this->Nxbin, this->min_x/cm, this->max_x/cm,
                          this->Nybin, this->min_y/cm,this->max_y/cm);
...
void HistoManager::Fill_Dose_2DHeatMap( G4double x, G4double y,G4double z)
{
  G4AnalysisManager* analysisManager = G4AnalysisManager::Instance(); 
